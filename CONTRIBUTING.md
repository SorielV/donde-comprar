...
En el Hackorama2019 by StickTrick entendemos el código como un bien de conocimiento que debe ser abierto a los ciudadanos y gobiernos de la región, por eso intentamos que, en la medida de lo posible, las herramientas digitales que tengan potencial de mejorar vidas en la región estén publicadas en la cuenta oficial de [@hackorama2019](github.com/hackorama2019) en Github.
...
Este proyecto tiene un [Código de Conducta](https://github.com/Hackorama2019/donde-comprar/blob/master/CODE-OF-CONDUCT.md). Esperamos que todos los que participen estén conformes con él. Lee el código para saber qué esperamos de los contribuidores.
